...
<main class="mx-auto max-w-6xl px-5 py-10 md:px-8">
  <div class="mb-8">
    <p class="label mb-2">Developer API</p>
    <h1 class="text-3xl font-bold text-on-surface md:text-5xl">QR code generation API</h1>
  ...
  <div class="grid gap-6">
    <section class="glass-panel rounded-card p-5 md:p-6">
      ...
      <div class="grid gap-3 md:grid-cols-2">
        ...
        <div class="rounded-lg border border-outline-variant bg-surface-low p-4">
          ...
          <p class="mt-2 text-sm text-on-surface-variant">Send JSON for larger payloads or nested style options.</p>
        </div>
      </div>
    </section>
        ...
        <table class="w-full min-w-[680px] text-left text-sm">
          ...
          <tbody class="divide-y divide-outline-variant text-on-surface-variant">
            <tr>
              ...
              <td class="py-3 pr-4">Defaults to guided unless <span class="mono">payload</span> is provided.</td>
            </tr>
            <tr>
              <td class="py-3 pr-4 mono">network</td>
              <td class="py-3 pr-4">network id | automatic</td>
              <td class="py-3 pr-4">Automatic detection supports the same address formats as the generator.</td>
            </tr>
            <tr>
              <td class="py-3 pr-4 mono">address</td>
              <td class="py-3 pr-4">string</td>
              <td class="py-3 pr-4">Validated for guided payment networks.</td>
            </tr>
            <tr>
              <td class="py-3 pr-4 mono">amount</td>
              <td class="py-3 pr-4">string</td>
              <td class="py-3 pr-4">Optional positive decimal amount. Invalid amounts are ignored.</td>
            </tr>
            <tr>
              <td class="py-3 pr-4 mono">payload</td>
              <td class="py-3 pr-4">string</td>
              <td class="py-3 pr-4">Required for custom mode. Limited to 4096 characters.</td>
            </tr>
            <tr>
              <td class="py-3 pr-4 mono">format</td>
              <td class="py-3 pr-4">svg | json</td>
              <td class="py-3 pr-4">SVG is returned as <span class="mono">image/svg+xml</span>. JSON includes payload, network, validation, and svg.</td>
            </tr>
            <tr>
              <td class="py-3 pr-4 mono">style</td>
              <td class="py-3 pr-4">object</td>
              <td class="py-3 pr-4">Supports foreground, background, margin, logo, logoVariant, and logoSize.</td>
            </tr>
          </tbody>
        </table>
      </div>
    ...
    <section class="grid gap-6 md:grid-cols-2">
      <div class="glass-panel rounded-card p-5 md:p-6">
        <h2 class="text-xl font-semibold">Supported Networks</h2>
      ...
      <div class="glass-panel rounded-card p-5 md:p-6">
        <h2 class="text-xl font-semibold">Token Chains</h2>
        <div class="mt-4 flex flex-wrap gap-2">
    ...
    <section class="glass-panel rounded-card p-5 md:p-6">
      <h2 class="text-xl font-semibold">Responses And Errors</h2>
      <div class="mt-4 grid gap-4 md:grid-cols-2">
        <div class="rounded-lg border border-outline-variant bg-surface-low p-4">
          <p class="label mb-2">Success</p>
